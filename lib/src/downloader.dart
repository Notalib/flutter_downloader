...
class FlutterDownloader {
  ...
  ///
  /// If [displayName] is set and if [showNotification] is true, sets title of notification.
  /// If this parameter is not set, the plugin will apply value of [fileName] or [url] parameter
  ///
