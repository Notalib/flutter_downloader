...
public class DownloadTask {
    ...
    DownloadTask(int primaryId, String taskId, int status, int progress, String url, String filename, String displayName, String savedDir,
    ...
    public String toString() {
        return "DownloadTask{taskId=" + taskId + ",status=" + status + ",progress=" + progress + ",url=" + url + ",filename=" + filename + ",displayName=" + displayName + ",savedDir=" + savedDir + ",headers=" + headers + ", saveInPublicStorage= " + saveInPublicStorage + "}";
    }
}
