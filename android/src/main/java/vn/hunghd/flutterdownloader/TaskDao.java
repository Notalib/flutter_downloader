...
public class TaskDao {
    ...
    final private String[] projection = new String[]{
            ...
            TaskContract.TaskEntry.COLUMN_NAME_DISPLAY_NAME,
    ...
    public void insertOrUpdateNewTask(String taskId, String url, int status, int progress, String fileName, String displayName,
        ...
        values.put(TaskContract.TaskEntry.COLUMN_NAME_DISPLAY_NAME, displayName);
    ...
    private DownloadTask parseCursor(Cursor cursor) {
        ...
        String displayName = cursor.getString(cursor.getColumnIndexOrThrow(TaskContract.TaskEntry.COLUMN_NAME_DISPLAY_NAME));
        ...
        return new DownloadTask(primaryId, taskId, status, progress, url, filename, displayName, savedDir, headers,
